...
internal static class WeaponProfileRegistry
{
	...
	private static readonly IReadOnlyDictionary<SpearKind, WeaponProfile> Profiles =
		new Dictionary<SpearKind, WeaponProfile> {
			...
			[SpearKind.Monarch] = new(SpearKind.Monarch, ItemTextureRoot + "MonarchsSpear", 260, 10, 8f, 10f, ItemRarityID.Red, Item.sellPrice(gold: 20), 0, 1.35f, 88, 8f, new Color(255, 245, 193), lightStrength: 0.35f, armorPenetration: 20, extraCrit: 6),
