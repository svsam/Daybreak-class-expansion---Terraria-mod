...
The current release is tested against Terraria 1.4.4.9 through tModLoader 2026.06, .NET 8, and C# 12. It supports single-player, host-and-play, and dedicated multiplayer servers.
